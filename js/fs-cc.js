(() => {
  var e,
    ...
    P = { main: x, consentsUpdated: `${x}-updated` },
    O = (e) => `[${x}-checkbox="${e}"]`,
    M = (e) => `${e}-activated`,
    j = `<style>${S.banner},${S.manager},${S.preferences},${k.interactionTrigger}{display:none}</style>`,
    L = Object.freeze({
      analytics: !1,
      essential: !0,
      marketing: !1,
    ...
    ee = class extends Y.default {
      ...
      loadConsents() {
        ...
        e &&
          ...
          X.get(P.consentsUpdated) &&
            ((() => {
              let e = X.get();
              for (let t in e) {
                if (t === P.main) continue;
      ...
      updateConsents(e, t) {
        ...
        ((e, t, n = 120) => {
          let i = { id: e, consents: t },
            r = encodeURIComponent(JSON.stringify(i));
          X.set(P.main, r, { expires: n });
        })(s, n.getConsents(), i),
          r &&
            ((e) => {
              g(
          ...
          o.length &&
            (((e = 120) => {
              X.set(P.consentsUpdated, "true", { expires: e });
            })(i),
            this.applyConsents(),
            G.alert(
              `The following consents were updated: ${o.join(", ")}`,
              "info"
            )),
  ...
  var ne,
    ...
    de = function (e) {
      ...
      return (
        !!(ce(t.target) || t.touches.length > 1) ||
            ...
            ie
              ...
              : (function (e) {
                  if (void 0 === ae) {
                    ...
                    t &&
                      n > 0 &&
                      ((ae = document.body.style.paddingRight),
    ...
    ue = function () {
      ie
        ? (re.forEach(function (e) {
          ...
          (se = -1))
        : (void 0 !== ae &&
            ((document.body.style.paddingRight = ae), (ae = void 0)),
          void 0 !== le &&
            ((document.body.style.overflow = le), (le = void 0))),
        (re = []);
    },
    fe = p(b()),
    me = class extends fe.default {
      constructor(e, t) {
        super(),
          (this.element = e),
          (this.store = t),
    ...
    ye = class extends pe.default {
      ...
      show(e = !0) {
        ...
        !t ||
          ...
          n.isVisible() === e ||
          (n[e ? "show" : "hide"](),
          i && (e ? he(r || t, { reserveScrollBarGap: !0 }) : ue()),
  ...
  window.FsCC = new (class {
    constructor() {
      y(this, "consentController"),
        ...
        y(this, "preferences"),
        y(this, "manager"),
        (this.consentController = new ee(this.store)),
    ...
    initComponents() {
      return g(this, null, function* () {
        ...
        t &&
          ...
          (this.banner = new ye(n, e)),
          (this.preferences = new ye(i, e)),
          (this.manager = new ye(r, e));
      });
    }
    init() {
      let { store: e, manager: t, banner: n } = this;
      document.head.insertAdjacentHTML("beforeend", j),
